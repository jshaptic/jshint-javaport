...
public class Options {
	...
	public static final Map<String, Map<String, Boolean>> bool = ImmutableMap.<String, Map<String, Boolean>>builder()
			.put("enforcing", ImmutableMap.<String, Boolean>builder()
					 ...
					 * // jshint varstmt: true
					 * 
					 * var a; // Warning: `var` declarations are forbidden. Use `let` or `const`
					 * instead.
					 */
			...
			// Third party globals
			.put("environments", ImmutableMap.<String, Boolean>builder()
			...
			// Obsolete options
			.put("obsolete", ImmutableMap.<String, Boolean>builder()
					.put("onecase", true) // if one case switch statements should be allowed
					.put("regexp", true) // if the . should not be allowed in regexp literals
					.put("regexdash", true) // if unescaped first/last dash (-) inside brackets
											// should be tolerated
					.build())
			.build();
	...
	private static final Map<String, Boolean> val = ImmutableMap.<String, Boolean>builder()
			...
			.put("ignore", false) // start/end ignoring lines of code, bypassing the lexer
									// start - start ignoring lines, including the current line
									// end - stop ignoring lines, starting on the next line
									// line - ignore warnings / errors for just a single line
									// (this option does not bypass the lexer)

			.put("ignoreDelimiters", false) // array of start/end delimiters used to ignore
	...
	public static final Map<String, Boolean> inverted = ImmutableMap.<String, Boolean>builder()
			.put("bitwise", true)
			.put("forin", true)
			.put("newcap", true)
			.put("plusplus", true)
	...
	public static final Set<String> validNames = ImmutableSet.<String>builder()
			.addAll(val.keySet())
			.addAll(bool.get("relaxing").keySet())
	...
	public static final Map<String, String> renamed = ImmutableMap.<String, String>builder()
			.put("eqeq", "eqeqeq")
			.put("windows", "wsh")
			.put("sloppy", "strict")
			.build();

	public static final Map<String, Boolean> removed = ImmutableMap.<String, Boolean>builder()
			.put("nomen", true)
			.put("onevar", true)
			.put("passfail", true)
			.put("white", true)
