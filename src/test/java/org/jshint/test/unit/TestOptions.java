...
public class TestOptions extends Assert
{
	...
	public void testAsi()
	{
	    ...
	    th.addError(9, 18, "Line breaking error 'continue'.");
	    th.addError(9, 26, "Missing semicolon.");
	    th.addError(10, 14, "Missing semicolon.");
	    th.addError(11, 18, "Line breaking error 'break'.");
	    ...
	    th.addError(19, 13, "Line breaking error 'break'.");
	    th.addError(19, 18, "Missing semicolon.");
	    th.addError(21, 13, "Line breaking error 'break'.");
	...
	public void testExpr()
	{
		...
		{
			th.newTest();
			th.addError(1, Integer.parseInt(exp[0]), "Expected an assignment or function call and instead saw an expression.");
	...
	public void testLoopfunc()
	{
		...
		th.addError(4, 13, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (v)");
	    th.addError(8, 13, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (v)");
	    th.addError(20, 11, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (nonExistent)");
	    th.addError(25, 13, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (p)");
	    ...
	    th.addError(42, 7, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (i)");
		th.test(src, new LinterOptions().set("es3", true));
		...
		th.newTest();
		th.addError(2, 13, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (i)");
	    th.addError(5, 11, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (i)");
	    th.addError(11, 9, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (i)");
	    th.addError(14, 15, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (i)");
	    th.addError(17, 9, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (i)");
	    ...
	    th.newTest();
	    th.addError(1, 25, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (i)");
	    th.addError(3, 16, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (j)");
	    ...
	    th.addError(6, 8, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (outerVar)");
	    th.addError(7, 8, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (innerVar)");
	    th.test(new String[] {
    		"var outerVar;",
            "",
            "while (false) {",
	    ...
	    th.addError(8, 8, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (mutableGlobal)");
	    th.addError(15, 10, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (immutableGlobal)");
	    th.test(new String[] {
	    ...
	    th.addError(10, 8, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (outerLet)");
	    th.addError(11, 8, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (innerLet)");
	    th.addError(18, 8, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (OuterClass)");
	    th.addError(19, 8, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (InnerClass)");
	    th.test(new String[] {
    		"let outerLet;",
            "const outerConst = 0;",
            "class OuterClass {}",
	    ...
	    th.addError(3, 11, "Functions declared within loops referencing an outer scoped variable may lead to confusing semantics. (a, b)");
	    th.test(new String[] {
    		"var a, b;",
            "for (;;) {",
            "  var f = function() {",
	...
	public void testBoss()
	{
	    ...
	    th.addError(4, 24, "Expected a conditional expression and instead saw an assignment.");
	    th.addError(7, 27, "Expected a conditional expression and instead saw an assignment.");
	    th.addError(12, 24, "Expected a conditional expression and instead saw an assignment.");

	    // GH-657
	    th.addError(14, 11, "Expected a conditional expression and instead saw an assignment.");
	    th.addError(17, 25, "Expected a conditional expression and instead saw an assignment.");
	    th.addError(20, 28, "Expected a conditional expression and instead saw an assignment.");
	    th.addError(25, 25, "Expected a conditional expression and instead saw an assignment.");

	    // GH-670
	    th.addError(28, 13, "Did you mean to return a conditional instead of an assignment?");
	    th.addError(32, 15, "Did you mean to return a conditional instead of an assignment?");
		th.test(src, new LinterOptions().set("es3", true));
	...
	public void testStrict()
	{
		...
		th.newTest();
		th.addError(4, 36, "If a strict mode function is executed using function invocation, its 'this' value will be undefined.");
	...
	public void testLaxbreak()
	{
		...
		for (int i = 0; i < ops.length; i++)
		{
			...
			th.newTest();
			th.addError(2, 1, "Misleading line break before '" + op + "'; readers may interpret this as an expression boundary.");
			th.test(code, new LinterOptions().set("es3", true));
	...
	public void testValidthis()
	{
		...
		th.addError(8, 9, "If a strict mode function is executed using function invocation, its 'this' value will be undefined.");
	    th.addError(9, 19, "If a strict mode function is executed using function invocation, its 'this' value will be undefined.");
	    th.addError(11, 19, "If a strict mode function is executed using function invocation, its 'this' value will be undefined.");
		th.test(src, new LinterOptions().set("es3", true));
	...
	public void testNocomma()
	{
		...
		th.addError(1, 11, "Unexpected use of a comma operator.");
	...
	public void testFutureHostile()
	{
		...
		th.addError(1, 5, "'JSON' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(2, 5, "'Map' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(3, 5, "'Promise' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(4, 5, "'Proxy' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(5, 5, "'Reflect' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(6, 5, "'Set' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(7, 5, "'Symbol' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(8, 5, "'WeakMap' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(9, 5, "'WeakSet' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(10, 5, "'ArrayBuffer' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(11, 5, "'DataView' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(12, 5, "'Int8Array' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(13, 5, "'Int16Array' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(14, 5, "'Int32Array' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(15, 5, "'Uint8Array' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(16, 5, "'Uint16Array' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(17, 5, "'Uint32Array' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(18, 5, "'Uint8ClampedArray' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(19, 5, "'Float32Array' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	    th.addError(20, 5, "'Float64Array' is defined in a future version of JavaScript. Use a different variable name to avoid migration issues.");
	...
	public void testModuleBehavior()
	{
		...
		th.addError(2, 23, "If a strict mode function is executed using function invocation, its 'this' value will be undefined.");
		...
		th.addError(3, 23, "If a strict mode function is executed using function invocation, its 'this' value will be undefined.");
		th.test(code);
